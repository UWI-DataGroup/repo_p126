...
**  DO-FILE METADATA
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\fan_fao_005b", replace
** HEADER -----------------------------------------------------
...
** ---------------------------------------------------------------------------------------------
import excel using "`datapath'/version01/2-working/Food_Security_Indicators_11SEP2018 Hambleton", sheet("I_4.8") cellra(c3:t251) first clear
