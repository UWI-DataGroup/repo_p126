* HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name			    fan_fao_005d.do
    //  project:				    Food and Nutrition (FaN)
    //  analysts:				    Ian HAMBLETON
    // 	date last modified	        22-OCT-2018
    //  algorithm task			    CEREAL IMPORT DEPENDENCY RATIO
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\fan_fao_005d", replace
** HEADER -----------------------------------------------------
...
** ---------------------------------------------------------------------------------------------
import excel using "`datapath'/version01/2-working/Food_Security_Indicators_11SEP2018 Hambleton", sheet("I_3.1") cellra(c3:t251) first clear
...
#delimit ;
	gr twoway
		...
		/// year 2015
		(sc cid est if group==1 & year==2011, msize(6) m(o) mlc(gs0) mfc("166 54 3%50") mlw(0.1))
		,
